     ...
     <div class="container">
        ...
        <header class="header-homepage">
            ...
            <nav>
                ...
                <ul class="header-homepage-list homepage-list--categories">
                    <li><a href="#">new</a></li>
                    <li><a href="">каталог</a></li>
                    <li><a href="">о&nbsp;нас</a></li> 
                </ul>

                <ul class="header-homepage-list homepage-list--languages">
                    <li><a href="#">RU
                        <img src="<?php bloginfo('template_url'); ?>/assets/imgs/svg/arrow.svg" alt="arrow"></a> 
                ...
                <ul class="header-homepage-list homepage-list--languages">  
                    <li><a href="#">UAH
                        ...
                        <ul class="submenu-languages submenu-languages--uan">
                            <li><a href="#">usd</a></li>
                            <li><a href="#">eur</a></li>
                        </ul>
                ...
                <ul class="header-homepage-list homepage-list--icons">
                    ...
                    <li><a href="page/2.html" target="_blank" aria-label="Корзина">
                        <svg width="25" height="25" viewBox="0 0 25 25" xmlns="http://www.w3.org/2000/svg">
